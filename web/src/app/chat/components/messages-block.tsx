                ...
                <div className="flex-grow">
                  <CardHeader>
                    ...
                    <CardDescription>
                      <RainbowText animated={responding}>
                        {responding
                          ? "BrightFloww is now replaying the conversation..."
                          : replayStarted
                            ? "The replay has been stopped."
                            : `You're now in BrightFlow's replay mode. Click the "Play" button on the right to start.`}
                      </RainbowText>
                    </CardDescription>
                  </CardHeader>
                </div>
            ...
            {!replayStarted && env.NEXT_PUBLIC_STATIC_WEBSITE_ONLY && (
              <div className="text-muted-foreground w-full text-center text-xs">
                * This site is for demo purposes only. If you want to try your
                ...
                <a
                  className="underline"
                  href="https://github.com/meirk-brd/deer-flow"
                  target="_blank"
